Feature: Chinese Chess (象棋) Rules
  ...
  Scenario: Red General tries to move diagonally (Illegal)

    Given the board is empty except for a Red General at (2, 5)

    When Red moves the General from (2, 5) to (3, 6)
